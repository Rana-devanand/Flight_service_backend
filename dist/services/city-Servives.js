...
var CityService = /*#__PURE__*/function () {
  ...
  return _createClass(CityService, [{
    key: "createCity",
    value: function () {
      var _createCity = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data) {
        var city, _t;
      ...
      var _getByName = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(name) {
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            ...
            case 1:
              allCities = _context3.v;
              return _context3.a(2, allCities);
            case 2:
              _context3.p = 2;
              _t3 = _context3.v;
              console.log("Something went wrong in service", _t3);
            case 3:
    ...
    key: "getCityByPk",
    value: function () {
      var _getCityByPk = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(id) {
        var city, _t4;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              _context4.p = 0;
              _context4.n = 1;
              return this.CityRepository.getByPk(id);
            case 1:
              city = _context4.v;
              return _context4.a(2, city);
            case 2:
              _context4.p = 2;
              _t4 = _context4.v;
              console.log("Something went wrong in service", _t4);
            case 3:
              return _context4.a(2);
          }
        }, _callee4, this, [[0, 2]]);
      }));
      function getCityByPk(_x4) {
        return _getCityByPk.apply(this, arguments);
      }
      return getCityByPk;
    }()
  }, {
      ...
      var _deleteCity = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(id) {
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            ...
            case 1:
              deleteCityRequest = _context6.v;
              return _context6.a(2, deleteCityRequest);
            case 2:
              _context6.p = 2;
              _t6 = _context6.v;
              console.log("Something went wrong when deleting city", _t6);
            case 3:
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            case 0:
              _context7.p = 0;
              _context7.n = 1;
              return this.CityRepository.getByCityName(cityName);
            case 1:
              city = _context7.v;
              return _context7.a(2, city);
            case 2:
              _context7.p = 2;
              _t7 = _context7.v;
              console.log("Something went wrong in service", _t7);
            case 3:

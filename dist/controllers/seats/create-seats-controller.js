...
var CreateSeatsServices = require("../../services/Create-seat-services");
var createSeatsServices = new CreateSeatsServices();
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return createSeatsServices.createSeat(req.body);
        case 1:
          response = _context.v;
...
var getseatclass = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return createSeatsServices.getSeatClass();
        case 1:
  ...
  return function getseatclass(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var getSeatbyid = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          _context3.p = 0;
          _context3.n = 1;
          return createSeatsServices.getSeatsPerRow(req.params.id);
        case 1:
  ...
  return function getSeatbyid(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var getSeatsByFlightId = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          _context4.p = 0;
          _context4.n = 1;
          return createSeatsServices.getSeatByFlightId(req.params.flight_id);
        case 1:
  ...
  return function getSeatsByFlightId(_x7, _x8) {

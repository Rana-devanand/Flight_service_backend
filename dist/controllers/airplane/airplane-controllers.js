...
var AirplaneServices = require("../../services/airplane-services");
var airplaneServices = new AirplaneServices();
var create = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var flightData, imagePath, flightsDetail, response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          flightsDetail = _objectSpread(_objectSpread({}, flightData), {}, {
            flightLogo: imagePath
          });
          _context.n = 1;
          return airplaneServices.createAirplaneService(flightsDetail);
        case 1:
          response = _context.v;
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          console.log("Error creating Airplane service ", _t);
...
var destroy = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return airplaneServices.deleteAirplaneService(req.params.id);
        case 1:
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          console.log("Error deleting Airplane service ", _t2);
  ...
  return function destroy(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var getByPk = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          _context3.p = 0;
          _context3.n = 1;
          return airplaneServices.getAirplaneByPK(req.params.id);
        case 1:
        ...
        case 2:
          _context3.p = 2;
          _t3 = _context3.v;
          console.log("Error to get Airplane By ID", _t3);
  ...
  return function getByPk(_x5, _x6) {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          _context4.p = 0;
          _context4.n = 1;
          return airplaneServices.getAllFLights(req.query);
        case 1:
...
var updateAirplane = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        case 0:
          ...
          _context5.n = 1;
          return airplaneServices.updateFlightByPk(req.params.id, req.body);
        case 1:
  ...
  return function updateAirplane(_x9, _x0) {
    return _ref5.apply(this, arguments);
  };
}();
var filterFlightData = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        case 0:
          _context6.p = 0;
          _context6.n = 1;
          return airplaneServices.fetchFilterFlightData(req.query);
        case 1:
  ...
  return function filterFlightData(_x1, _x10) {
    return _ref6.apply(this, arguments);
  };
}();
var dailyFlights = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context7) {
      while (1) switch (_context7.p = _context7.n) {
        case 0:
          _context7.p = 0;
          _context7.n = 1;
          return airplaneServices.getDailyFlights(req.query);
        case 1:
  ...
  return function dailyFlights(_x11, _x12) {
    return _ref7.apply(this, arguments);
  };
}();
var getByFlightId = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context8) {
      while (1) switch (_context8.p = _context8.n) {
        case 0:
          _context8.p = 0;
          _context8.n = 1;
          return airplaneServices.getByFlightId(req.params.id);
        case 1:
  ...
  return function getByFlightId(_x13, _x14) {
    return _ref8.apply(this, arguments);
  };
}();
var findAllFLightAndSchedule = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context9) {
      while (1) switch (_context9.p = _context9.n) {
        case 0:
          _context9.p = 0;
          _context9.n = 1;
          return airplaneServices.getAllInnerJoinFlights();
        case 1:
  ...
  return function findAllFLightAndSchedule(_x15, _x16) {
    return _ref9.apply(this, arguments);
  };
}();
var findAllFLightAndScheduleById = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context0) {
      while (1) switch (_context0.p = _context0.n) {
        case 0:
          _context0.p = 0;
          _context0.n = 1;
          return airplaneServices.getAllFlightAndScheduleById(req.params.flightId);
        case 1:
  ...
  return function findAllFLightAndScheduleById(_x17, _x18) {
...
module.exports = {
  ...
  getByFlightId: getByFlightId,
  findAllFLightAndSchedule: findAllFLightAndSchedule,
  findAllFLightAndScheduleById: findAllFLightAndScheduleById
};
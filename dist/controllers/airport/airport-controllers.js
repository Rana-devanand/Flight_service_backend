...
var AirportServices = require("../../services/airport-services");
var airportServices = new AirportServices();
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          _context.n = 1;
          return airportServices.createAirportService(req.body);
        case 1:
          response = _context.v;
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          console.error("Error creating Airport controller", _t);
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return airportServices.getAllAirports(req.query);
        case 1:
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          console.error("Error getall Airport controller", _t2);
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          _context3.p = 0;
          _context3.n = 1;
          return airportServices.getAirportById(req.params.id);
        case 1:
        ...
        case 2:
          _context3.p = 2;
          _t3 = _context3.v;
          console.error("Error get by Id Airport ", _t3);
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          _context4.p = 0;
          _context4.n = 1;
          return airportServices.updateAirport(req.params.id, req.body);
        case 1:
        ...
        case 2:
          _context4.p = 2;
          _t4 = _context4.v;
          console.error("Error update Airport controller", _t4);
...
var destroy = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        case 0:
          _context5.p = 0;
          _context5.n = 1;
          return airportServices.deleteAirport(req.params.id);
        case 1:
        ...
        case 2:
          _context5.p = 2;
          _t5 = _context5.v;
          console.error("Error delete Airport controller", _t5);
  ...
  return function destroy(_x9, _x0) {

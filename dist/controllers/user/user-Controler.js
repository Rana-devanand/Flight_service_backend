...
var _require = require("../../services/user-Services"),
  UserServices = _require.UserServices;
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return userServices.createUser(req.body);
        case 1:
          response = _context.v;
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          console.log("An error occurred while creating the user", _t);
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return userServices.getUser(req.body);
        case 1:
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          console.error("An error occurred while fetching the user", _t2);
          res.status(500).json({
            data: {},
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          _context3.p = 0;
          _context3.n = 1;
          return userServices.getUserEmail(req.params.email);
        case 1:
        ...
        case 2:
          _context3.p = 2;
          _t3 = _context3.v;
          console.log("An error occurred while fetching user information from email", _t3);
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          ...
          _context4.n = 1;
          return userServices.signIn(req.body.email, req.body.password);
        case 1:
...
var getUserById = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        case 0:
          ...
          _context5.n = 1;
          return userServices.getUserById(req.params.id);
        case 1:
  ...
  return function getUserById(_x9, _x0) {
...
var updatePassword = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        case 0:
          ...
          _context6.n = 1;
          return userServices.updatePassword(req.body.id, req.body.password);
        case 1:
  ...
  return function updatePassword(_x1, _x10) {
